...
public class RdsBinlogEventParserProxy extends MysqlEventParser {
    ...
    public void start() {
        if (rdsLocalBinlogEventParser == null && StringUtils.isNotEmpty(accesskey) && StringUtils.isNotEmpty(secretkey)
            ...
            rdsLocalBinlogEventParser.setFilterRowsInsert(this.filterRowsInsert);
            rdsLocalBinlogEventParser.setFilterRowsUpdate(this.filterRowsUpdate);
            rdsLocalBinlogEventParser.setFilterRowsDelete(this.filterRowsDelete);
