...
public abstract class AbstractMysqlEventParser extends AbstractEventParser {
    ...
    protected boolean              filterRowsInsert          = false;
    protected boolean              filterRowsUpdate          = false;
    protected boolean              filterRowsDelete          = false;
    ...
    protected BinlogParser buildParser() {
        ...
        convert.setFilterRowsInsert(filterRowsInsert);
        convert.setFilterRowsUpdate(filterRowsUpdate);
        convert.setFilterRowsDelete(filterRowsDelete);
    ...
    public void setFilterRowsInsert(boolean filterRowsInsert) {
        this.filterRowsInsert = filterRowsInsert;
    }

    public void setFilterRowsUpdate(boolean filterRowsUpdate) {
        this.filterRowsUpdate = filterRowsUpdate;
    }

    public void setFilterRowsDelete(boolean filterRowsDelete) {
        this.filterRowsDelete = filterRowsDelete;
    }
