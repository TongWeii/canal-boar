...
public class CanalStarter {
    ...
    private static MQProperties buildMQProperties(Properties properties) {
        ...
        String filterTransactionEntry = CanalController.getProperty(properties, CanalConstants.INSTANCE_FILTER_TRANSACTION_ENTRY);
        if (!StringUtils.isEmpty(filterTransactionEntry)){
